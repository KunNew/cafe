  ...
  <v-container fluid>
      ...
      <v-card>
          <v-card-subtitle>
              ...
              <v-btn class="ma-1" color="warning" :to="{ name: 'user-id',params:{id: model.id} }"><v-icon left>mdi-pencil-box-outline</v-icon>Edit user</v-btn>
          </v-card-subtitle>
...
export default {
  ...
  methods:
  {
      fetchData()
      {
          axiosApiInstance.get(`user/${ this.$route.params.id }`)
          .then(response => {
