<template>
  <v-container fluid>
    ...
    >
      <template #[`top`]>
        <v-toolbar flat>
          <v-btn class="ma-1" color="primary" to="user/create"
        ...
        <v-tooltip top>
          <template #activator="{ on, attrs }">
            <v-btn
              ...
              small
              :to="
                localePath({ name: 'user-show-id', params: { id: item.id } })
              "
              v-on="on"
        ...
        <v-tooltip top>
          <template #activator="{ on, attrs }">
            <v-btn
              ...
              icon
              small
              :to="localePath({ name: 'user-id', params: { id: item.id } })"
              v-bind="attrs"
              v-on="on"
