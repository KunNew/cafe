            ...
            <v-card flat>
              <v-card-text>
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-btn type="submit" :loading="formProfile.submitting" color="success">Save</v-btn>
                  </v-col>
                </v-row>
              </v-card-text>
            </v-card>
                ...
                <v-row>
                  ...
                  <v-col cols="12" class="py-0">
                    <v-text-field
                        ...
                        prepend-inner-icon="mdi-lock"
                        required
                        :rules="[v => !!v || 'New password', v => (v && v.length >= 8) ||  'Password must be at least 8']"
                        type="password"
                        outlined>
                    </v-text-field>
                  </v-col>
                  ...
                  <v-col cols="12">
                    <v-btn type="submit" ref="btn_change_password" :loading="formPassword.submitting" color="success">Save</v-btn>
                  </v-col>
                </v-row>
                </v-form>
            </v-card-text>
      ...
      computed: {
        ...
        confirmPasswordRule()
        {
          return [
            ...
            () => this.formPassword.data.password == this.formPassword.data.confirm_password || 'Password does not match'
          ]
        }
      },
